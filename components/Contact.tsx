              ...
              {submitted ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full bg-[rgb(20,30,70)] text-white py-3 px-6 rounded-md font-semibold hover:bg-[rgb(30,40,80)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
